# open-cu-services-lmsapi
A client library for accessing CU LMS API

## Usage
First, create a client:

```python
from open_cu_services_lmsapi import Client
...
```python
from open_cu_services_lmsapi import AuthenticatedClient
...
```python
from open_cu_services_lmsapi.models import MyDataModel
from open_cu_services_lmsapi.api.my_tag import get_my_data_model
...
1. Any endpoint which did not have a tag will be in `open_cu_services_lmsapi.api.default`
