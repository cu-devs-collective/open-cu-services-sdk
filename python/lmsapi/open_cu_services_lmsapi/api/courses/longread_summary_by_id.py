...
from ...models.longread_summary_by_id_response import LongreadSummaryByIdResponse
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/micro-lms/longreads/{longread_id}".format(
...
) -> BaseBadRequestError | BaseNotFoundError | BaseProblemError | BaseUnauthorizedError | LongreadSummaryByIdResponse:
    if response.status_code == 200:
        response_200 = LongreadSummaryByIdResponse.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[BaseBadRequestError | BaseNotFoundError | BaseProblemError | BaseUnauthorizedError | LongreadSummaryByIdResponse]
    """
