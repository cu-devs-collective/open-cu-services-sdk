...
T = TypeVar("T", bound="LongreadExerciseSingleChoiceQuestionitemSingleChoice")


@_attrs_define
class LongreadExerciseSingleChoiceQuestionitemSingleChoice:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        longread_exercise_single_choice_questionitem_single_choice = cls(
            options=options,
        )

        return longread_exercise_single_choice_questionitem_single_choice
